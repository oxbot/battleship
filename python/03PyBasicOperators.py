...
#Exercise
#The target of this exercise is to create two lists called x_list and
#y_list, which contain 10 instances of the variables x and y,
# respectively. You are also required to create a list called
# big_list, which contains the variables x and y, 10 times each,
